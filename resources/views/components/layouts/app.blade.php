...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/front/images/wikrama.png') }}" type="image/x-icon">
        ...
        <nav class="navbar navbar-expand-xl navbar-light text-center py-3">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img loading="prelaod" decoding="async" class="img-fluid" width="135" src="{{ asset('/front/images/wikrama.png') }}" alt="Wallet">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a href="{{ route('contactPage') }}" class="btn btn-outline-primary">Contact Us</a>
                </div>
            </div>
        </nav>
    </header>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2"><a href="{{ route('page', 1) }}">About</a>
                            </li>
                        <li class="mb-2"><a href="{{ route('contactPage') }}">Contact</a>
                            </li>
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            <li class="list-inline-item me-4"><a class="text-black" href="{{ route('page', 4) }}">Privacy Policy</a>
                            </li>
