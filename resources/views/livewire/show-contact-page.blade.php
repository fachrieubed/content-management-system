                ...
                <div class="row">
                    <div class="col-8 mx-auto text-center">
                        ...
                        <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                            ...
                            <li class="list-inline-item">/ &nbsp; <a href="{{ Route('contactPage') }}">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="contact-form">
                                        <form wire:submit="submit">
                                            ...
                                            <div class="form-group mb-4 pb-2">
                                                ...
                                                <textarea class="form-control shadow-none" id="message" name="message" rows="3"></textarea>
                                            </div>
                                    ...
                                    <div class="contact-info">
                                        <div class="block mt-0">
                                            ...
                                            <div class="content">
                                                ...
                                                <br>
                                                <a href="https://wa.me/6285776025560" target="_blank" class="text-primary">
                                                    +62 857-7602-5560
                                                </a>
                                                <br>
                                                Address:
                                                <br>
                                                <a href="https://www.google.com/maps/place/-6.6478053,106.9071557" target="_blank" class="text-primary">
                                                    View on Google Maps
                                                </a>
                                            </div>
                                        </div>
